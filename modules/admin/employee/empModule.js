    ...
    emp_details_save: (data) => {
        return new Promise(async (resolve, reject) => {
            ...
            var table_name = "md_employee",
                ...
                values = `('${emp_code}','${data.branch_code}','0','${data.emp_name}','${data.gender}','${data.guardian_name}','${data.addr.split("'").join("\\'")}','${data.district.split("'").join("\\'")}','${data.pin_code}','${data.phone_home}','${data.phone_mobile}','${data.email}','${data.designation}','${data.nationality}','${data.dob}','${data.married}','${data.language_known}',${data.doj == '' ? 'NULL' : `'${data.doj}'`},'${data.prob_period}','${data.retairment_age}','${data.conf_dt}','${data.retair_dt}','${data.blood_grp}','${data.voter_id}','${data.pan_no}','${data.aadhar_no}','${data.bank_name}','${data.branch_name}','${data.ifsc}','${data.acc_no}','${data.remarks.split("'").join("\\'")}','${data.created_by}','${datetime}')`,
