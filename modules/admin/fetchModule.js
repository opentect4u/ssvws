...
module.exports = {
    edit_grp_web: (data) => {
        return new Promise(async (resolve, reject) => {
            ...
            '${data.email_id}', '${data.grp_addr}', '${data.district}', '${data.block == 'undefined' ? 0 : data.block}', '${data.pin_no}', '${data.bank_name}', '${data.branch_name}', '${data.ifsc}', '${data.micr}', '${data.acc_no1 == '' ? 0 : data.acc_no1}',
