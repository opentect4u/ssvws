    ...
    loan_trans: (data) => {
        return new Promise(async (resolve, reject) => {
            ...
            if(trans_dt.suc > 0 && trans_dt.msg.length > 0){
                ...
                fields =`(payment_date,payment_id,branch_id,loan_id,particulars,credit,debit,bank_charge,proc_charge,prn_recov,intt_recov,balance,tr_type,tr_mode,bank_name,cheque_id,chq_dt,status,created_by,created_at)`,
