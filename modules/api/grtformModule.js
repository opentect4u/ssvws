    ...
    save_basic_dtls: (data) => {
        return new Promise(async (resolve, reject) => {
            ...
            // if(mobile_dt.suc > 0 && mobile_dt.msg.length == 0){
                    ...
                    values = `('${form_no}', '${datetime}', '${data.branch_code}', '${group_code}', '${current_member_code}', 'U', '${data.co_lat_val}', '${data.co_long_val}', '${data.co_gps_address}', '${data.created_by}', '${datetime}')`,
                    whr = null,
                    flag =  0;
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if(res_dt.msg.length > 0 && res_dt.suc > 0){
                ...
                var table_name = "td_grt_occupation_household",
                    ...
                    values = `('${data.no_of_rooms}', '${data.house_type}', '${data.own_rent}', '${data.land == '' ? 0 : data.land}', '${data.tv_flag}', '${data.bike_flag}', '${data.fridge_flag}', '${data.wm_flag}','${data.poltical_flag}', '${data.parental_addr}', '${data.parental_phone}', '${data.created_by}', ${datetime})`,
                    whr = null,
                    flag = 0;
                    var house_hold_dt = await db_Insert(table_name, fields, values, whr, flag);
            }
