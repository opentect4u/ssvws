...
recoveryRouter.post("/search_group_app", async (req, res) => {
    ...
    var select = "a.group_code,a.period,b.group_name,SUM(a.prn_amt + a.od_prn_amt) AS total_prn_amt,SUM(a.intt_amt + a.od_intt_amt) AS total_intt_amt,c.status,b.group_type",
