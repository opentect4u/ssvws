    ...
    try {
        ...
        if(res_dt.suc > 0){
            if(res_dt.msg.length > 0){
                var default_chk = await db_Select('a.outstanding,b.branch_name', 'td_loan a LEFT JOIN md_branch b ON a.branch_id = b.branch_code', `a.sub_customer_id=${res_dt.msg[0].member_code}`, `HAVING a.outstanding > 0`)
