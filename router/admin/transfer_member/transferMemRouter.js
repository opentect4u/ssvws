...
// console.log(data,'memedata');
 ...
 try{
    ...
    res.send(view_co_trans_dt)
        ...
        var select = "a.mem_trans_date,a.member_code,a.from_group from_group_code,a.from_branch from_branch_code,a.from_co from_co_id,a.to_group to_group_code,a.to_branch to_branch_code,a.to_co to_co_id,a.remarks,a.approval_status,a.created_by created_code,a.created_at,a.approved_by approved_code,i.emp_name approved_by,a.approved_at,b.client_name,c.group_name from_group,d.emp_name from_co,e.branch_name from_branch,f.group_name to_group,g.emp_name to_co,h.branch_name to_branch",
        table_name = "td_member_transfer a LEFT JOIN md_member b ON a.member_code = b.member_code LEFT JOIN md_group c ON a.from_group = c.group_code LEFT JOIN md_employee d ON a.from_co = d.emp_id LEFT JOIN md_branch e ON a.from_branch = e.branch_code LEFT JOIN md_group f ON a.to_group = f.group_code LEFT JOIN md_employee g ON a.to_co = g.emp_id LEFT JOIN md_branch h ON a.to_branch = h.branch_code LEFT JOIN md_employee i ON a.approved_by = i.emp_id",
