...
loan_rejectionRouter.post("/search_reject_loan_trans", async (req, res) => {
 try{
   ...
   var select = `a.payment_date,a.payment_id,b.branch_code,c.branch_name,b.group_code,d.group_name,a.loan_id,b. member_code,e.client_name,a.particulars,a.credit,a.debit,a.balance,a.od_balance,a.intt_balance,a.tr_type,a.tr_mode,a.reject_remarks,a.created_by created_code,f.emp_name created_by,a.created_at,a.modified_by   modified_code,g.emp_name modified_by,a.modified_at,a.approved_by approved_code,h.emp_name approved_by,a.approved_at,a.rejected_by rejected_code,i.emp_name rejected_by,a.rejected_at`,
