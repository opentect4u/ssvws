...
loanRouter.post("/fetch_loan_application_dtls", async (req, res) => {
    ...
    var select = "a.branch_code,a.member_code,a.client_name,b.form_no,DATE(b.grt_date) application_date,b.prov_grp_code,DATE(b.approved_at) grt_approve_date,c.branch_name,d.group_name,e.applied_amt,e.loan_purpose,e.sub_pupose,f.purpose_id,g.sub_purp_name",
