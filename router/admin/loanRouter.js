...
loanRouter.post("/fetch_loan_application_dtls", async (req, res) => {
    ...
    whr = `(a.member_code like '%${data.member_dtls}%' OR a.client_name like '%${data.member_dtls}%' OR a.client_mobile like '%${data.member_dtls}%' OR b.form_no like '%${data.member_dtls}%') AND b.approval_status = 'A'`,
    order = null;
