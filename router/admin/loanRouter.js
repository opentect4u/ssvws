...
loanRouter.post("/fetch_disb_trans_dtls", async (req, res) => {
  ...
  order = `GROUP BY a.scheme_id,a.fund_id,a.period,a.curr_roi,a.recovery_day,a.period_mode,b.bank_charge,b.proc_charge,b.bank_name,c.scheme_name,d.fund_name,e.bank_name`;
