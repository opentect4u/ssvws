        ...
        try {
            ...
            if (isCurrentDate) {
                ...
                if(res_dt.suc > 0 && res_dt.msg.length > 0){
                    ...
                    var select = "a.loan_id,d.form_no,c.member_code,c.client_name,c.client_mobile,c.dob, TIMESTAMPDIFF(YEAR, c.dob, CURDATE()) AS age,c.gurd_name,c.husband_name,c.client_addr,c.voter_id,c.pan_no,c.aadhar_no,c.nominee_name,e.group_code,e.group_name,e.co_id,e.bank_name,e.acc_no1,e.acc_no2,e.emp_name co_name,b.fund_id,g.fund_name,b.scheme_id,h.scheme_name,b.purpose,i.purpose_id,b.applied_dt,b.applied_amt,b.disb_dt loan_date,b.prn_disb_amt loan_amount,b.curr_roi,b.recovery_day,a.prn_amt prn_outstanding,a.intt_amt intt_outstanding,a.outstanding outstanding",
