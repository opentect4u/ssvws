        ...
        try {
            ...
            // }else {
                ...
                if(res_dt.suc > 0 && res_dt.msg.length > 0){
                    ...
                    whr = `a.balance_date = '${balance_date}' AND a.branch_code IN (${data.branch_code})`,
                    order = `GROUP BY a.branch_code,j.branch_name,a.loan_id,d.form_no,c.member_code,c.client_name,c.client_mobile,c.dob, TIMESTAMPDIFF(YEAR, c.dob, CURDATE()),c.gurd_name,c.husband_name,c.client_addr,c.voter_id,c.pan_no,c.aadhar_no,c.nominee_name,e.group_code,e.group_name,e.co_id,e.bank_name,e.acc_no1,e.acc_no2,f.emp_name,b.fund_id,g.fund_name,b.scheme_id,h.scheme_name,b.purpose,i.purpose_id,b.applied_dt,b.applied_amt,b.disb_dt,b.prn_disb_am,b.curr_roi,b.recovery_day,a.prn_amt,a.intt_amt
