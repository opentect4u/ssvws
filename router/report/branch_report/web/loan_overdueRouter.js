  ...
  loan_overdueRouter.post("/loan_overdue_report_groupwise", async (req, res) => {
    try {
        ...
        for(let dt of data.search_brn_id){
            var select = "a.trf_date,a.od_date first_od_date,a.branch_code,c.branch_name,b.group_code,d.group_name,b.co_id code,e.emp_name co_id,b.recovery_day,b.disb_dt,a.disb_amt,b.instl_end_dt,b.period,b.period_mode,a.od_amt,SUM(b.prn_amt + b.od_prn_amt + b.intt_amt) outstanding",
            table_name = "td_od_loan a LEFT JOIN td_loan b ON a.loan_id = b.loan_id LEFT JOIN md_branch c ON a.branch_code = c.branch_code LEFT JOIN md_group d ON b.group_code = d.group_code LEFT JOIN md_employee e ON b.co_id = e.emp_id",
