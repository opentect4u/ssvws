...
loan_closeRouter.post("/loan_close_report_memberwise", async (req, res) => {
    ...
    var select = "max(payment_date)payment_date,branch_code,member_code,client_name,loan_id,group_code,group_name,co_id,emp_name,purpose,purpose_id,scheme_id,scheme_name,fund_id,fund_name,curr_roi,period,period_mode,disb_dt,sum(debit_amt)debit_amt,sum(credit_amt)credit_amt",
    table_name = `(SELECT b.payment_date,a.branch_code,a.member_code,c.client_name,a.loan_id,a.group_code,d.group_name,d.co_id,h.emp_name,a.purpose,e.purpose_id,a.scheme_id,f.scheme_name,a.fund_id,g.fund_name,a.curr_roi,a.period,a.period_mode,a.disb_dt,0 debit_amt, 0 credit_amt
    ...
    SELECT '' payment_date,a.branch_code,a.member_code,c.client_name,a.loan_id,a.group_code,d.group_name,d.co_id,h.emp_name,a.purpose,e.purpose_id,a.scheme_id,f.scheme_name,a.fund_id,g.fund_name,a.curr_roi,a.period,a.period_mode,a.disb_dt,a.prn_disb_amt debit_amt, 0 credit_amt
    FROM td_loan a,td_loan_transactions b,md_member c,md_group d,md_purpose e,md_scheme f,md_fund g,md_employee h
    WHERE a.loan_id = b.loan_id
    AND a.member_code = c.member_code
    AND a.group_code = d.group_code
    ...
    SELECT '' payment_date,a.branch_code,a.member_code,c.client_name,a.loan_id,a.group_code,d.group_name,d.co_id,h.emp_name,a.purpose,e.purpose_id,a.scheme_id,f.scheme_name,a.fund_id,g.fund_name,a.curr_roi,a.period,a.period_mode,a.disb_dt,0 debit_amt, sum(b.credit)credit_amt
    FROM td_loan a,td_loan_transactions b,md_member c,md_group d,md_purpose e,md_scheme f,md_fund g,md_employee h
    WHERE a.loan_id = b.loan_id
    AND a.member_code = c.member_code
    AND a.group_code = d.group_code
