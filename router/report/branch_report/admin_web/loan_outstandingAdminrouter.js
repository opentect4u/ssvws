...
loan_outstandingAdminrouter = express.Router(),
dateFormat = require('dateformat');

loan_outstandingAdminrouter.post("/loan_outstanding_report_memberwise_admin", async (req, res) => {
    try {
...
loan_outstandingAdminrouter.post("/loan_outstanding_report_groupwise_admin", async (req, res) => {
    try {
...
module.exports = {loan_outstandingAdminrouter}