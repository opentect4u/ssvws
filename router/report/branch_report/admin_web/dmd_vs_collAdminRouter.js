...
dmd_vs_collAdminRouter = express.Router(),
dateFormat = require('dateformat');

//DEMAND VS COLLECTION REPORT MEMBERWISE ADMIN
dmd_vs_collAdminRouter.post("/dmd_vs_collec_report_memberwise_admin", async (req, res) => {
    try {
        var data = req.body;
...
//DEMAND VS COLLECTION REPORT GROUPWISE ADMIN
dmd_vs_collAdminRouter.post("/dmd_vs_collec_report_groupwise_admin", async (req, res) => {
    try {
        var data = req.body;
        const pro_name = 'p_loan_demand',
        pro_params = `?,?,?`,
...
//DEMAND VS COLLECTION REPORT COWISE ADMIN
dmd_vs_collAdminRouter.post("/dmd_vs_collec_report_cowise_admin", async (req, res) => {
    try {
        var data = req.body;
        const pro_name = 'p_loan_demand',
        pro_params = `?,?,?`,
...
module.exports = {dmd_vs_collAdminRouter}