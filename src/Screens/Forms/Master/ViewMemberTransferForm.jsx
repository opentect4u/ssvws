...
function ViewMemberTransferForm({state}) {
    ...
    const approveTransferGroup = () => {
      ...
      setLoading(true)
      // console.log(cred);
      axios.post(`${url}/approve_member_trans_dt`,cred).then(res=>{console.log(res)
         setLoading(false)
        if(res?.data?.suc){
                ...
                <table className="w-full border rounded-md">
                  ...
                  <tbody>
                    <tr className="bg-slate-300 text-slate-700 text-center">
                      ...
                      <td className="px-4 py-2 text-sm">{mem_dtls[0]?.from_branch}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="w-full border rounded-md">
                  ...
                  <tbody>
                    <tr className="bg-slate-300 text-slate-700 text-center">
                      ...
                      <td className="px-4 py-2 text-sm">{mem_dtls[0]?.to_branch}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
